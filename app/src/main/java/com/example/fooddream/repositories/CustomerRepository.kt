...
class CustomerRepository(private var view: AppCompatActivity) {
    ...
    fun updateCustomer(newFName: String, newLName: String) {
        ...
        if (customer != null) {
            ...
            notification.sendNotification("Error updating the user", view)
            Log.d("Customer Repository", "No customer found in update.")
        }
    }
}
